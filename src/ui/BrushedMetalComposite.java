...
public class BrushedMetalComposite extends Composite {
     ...
     * @param palette
     *            the palette associated to the imageData
     * @param posX
     ...
     * @param pixels
     *            An array containing the pixel data to place between x,y and
     *            x+w-1, y+h-1.
     */
    private void setDataElements(final ImageData data, final PaletteData palette, final int posX, final int posY,
     ...
     * 
     * @param in
     *            the array of int that represents the image
     * @param width
     *            the width of the image
     * @param radius
     *            the "radius" blur parameter
     */
