...
//				}
	...
	static Star initSmall(final StarRating parent) {
		...
		star.hoverImage = new Image(Display.getCurrent(), star.getClass().getClassLoader().getResourceAsStream("stars/focus16.png"));
		star.halfSelectedImage = new Image(Display.getCurrent(), star.getClass().getClassLoader().getResourceAsStream("stars/mark16half.png"));
		star.selectedImage = new Image(Display.getCurrent(), star.getClass().getClassLoader().getResourceAsStream("stars/mark16.png"));
		star.selectedHoverImage = new Image(Display.getCurrent(), star.getClass().getClassLoader().getResourceAsStream("stars/mark-focus16.png"));
		return star;
	}
}
